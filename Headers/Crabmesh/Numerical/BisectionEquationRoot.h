...
public:
    ...
    virtual double execute(EquationRootFunction *function, int maxSteps, double tolerance, bool testFunction, bool testStepSize, bool &ok);
    virtual double execute(EquationRootFunction *function, int maxSteps, double tolerance, bool &ok);
    virtual double execute(EquationRootFunction *function, bool &ok);
    virtual double execute(EquationRootFunction *function);

};

class ClosestBisectionEquationRoot : public Data::Numerical::BisectionEquationRoot
{
public:
...
protected:
    ...
    virtual double recursiveExecute(EquationRootFunction *function, double min, double max, double fmin, double fmax,
