...
namespace Parallel
{
	...
	public:
		...
		virtual void receive(void *buffer, Int size, enum Type type, Int process, Int tag) const;
		using Parallel::Communicator::ireceive;
		virtual UInt ireceive(void *buffer, Int size, enum Type type, Int process, Int tag) const;
