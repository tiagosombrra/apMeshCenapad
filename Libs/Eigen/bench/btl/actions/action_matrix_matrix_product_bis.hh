 ...
 public:
  ...
  static double calculate(int nb_calc, int size) {
    ...
    do {
      ...
      //      Interface::matrix_matrix_product(A,B,X,size); This line must be
      //      commented !!!!
    } while (chronos.check());
    ...
    do {
      ...
      Interface::matrix_matrix_product(A, B, X,
                                       size);  // here it is not commented !!!!
    } while (chronos.check());
    ...
    STL_interface<typename Interface::real_type>::matrix_matrix_product(
        A_stl, B_stl, X_stl, size);

    typename Interface::real_type error =
        STL_interface<typename Interface::real_type>::norm_diff(X_stl,
                                                                resu_stl);
