...
int main(int argc, char **args) {
  ...
  ConjugateGradient<SparseMatrix<double, ColMajor>, Lower,
                    IncompleteCholesky<double, Lower> >
      solver;
  ...
  /* Fill the matrix with sparse matrix stored in Matrix-Market coordinate
  ...
  //   endl; SparseMatrix<double, RowMajor> mat1(A); SparseMatrix<double,
  //   RowMajor> mat2; cout << " norm of A " << mat1.norm() << endl; ;
