...
/* Subroutine */ int ctbmv_(char *uplo, char *trans, char *diag, integer *n,
  ...
  if (!lsame_(uplo, "U", (ftnlen)1, (ftnlen)1) &&
      !lsame_(uplo, "L", (ftnlen)1, (ftnlen)1)) {
    info = 1;
  } else if (!lsame_(trans, "N", (ftnlen)1, (ftnlen)1) &&
             !lsame_(trans, "T", (ftnlen)1, (ftnlen)1) &&
             !lsame_(trans, "C", (ftnlen)1, (ftnlen)1)) {
    info = 2;
  } else if (!lsame_(diag, "U", (ftnlen)1, (ftnlen)1) &&
             !lsame_(diag, "N", (ftnlen)1, (ftnlen)1)) {
    info = 3;
  } else if (*n < 0) {
    info = 4;
  } else if (*k < 0) {
        ...
        for (j = *n; j >= 1; --j) {
          ...
          if (x[i__1].r != 0.f || x[i__1].i != 0.f) {
            ...
            for (i__ = min(i__1, i__3); i__ >= i__4; --i__) {
              ...
              q__2.i = temp.r * a[i__2].i + temp.i * a[i__2].r;
              q__1.r = x[i__3].r + q__2.r, q__1.i = x[i__3].i + q__2.i;
        ...
        for (j = *n; j >= 1; --j) {
          ...
          if (noconj) {
            if (nounit) {
              ...
              q__1.i = temp.r * a[i__3].i + temp.i * a[i__3].r;
            ...
            for (i__ = j - 1; i__ >= i__3; --i__) {
              ...
              q__2.i = q__3.r * x[i__4].i + q__3.i * x[i__4].r;
              q__1.r = temp.r + q__2.r, q__1.i = temp.i + q__2.i;
              temp.r = q__1.r, temp.i = q__1.i;
              /* L100: */
            }
        ...
        for (j = 1; j <= i__3; ++j) {
          ...
          if (noconj) {
            if (nounit) {
              ...
              q__1.i = temp.r * a[i__4].i + temp.i * a[i__4].r;
              temp.r = q__1.r, temp.i = q__1.i;
            }
            /* Computing MIN */
            i__1 = *n, i__2 = j + *k;
