...
// factors are unitary The SVD must have already been computed.
...
void svd_compare_to_full(const MatrixType& m, unsigned int computationOptions,
  ...
  // then different matrix-matrix product implementation will be used and the
  // resulting 'V' factor might be significantly different when the SVD
