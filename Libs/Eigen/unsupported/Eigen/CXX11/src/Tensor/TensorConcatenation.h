...
class TensorConcatenationOp
 ...
 public:
  ...
  EIGEN_DEVICE_FUNC
  EIGEN_STRONG_INLINE TensorConcatenationOp& operator=(
      const TensorConcatenationOp& other) {
    typedef TensorAssignOp<TensorConcatenationOp, const TensorConcatenationOp>
        Assign;
  ...
  EIGEN_DEVICE_FUNC EIGEN_STRONG_INLINE TensorConcatenationOp& operator=(
...
struct TensorEvaluator<TensorConcatenationOp<Axis, LeftArgType, RightArgType>,
  ...
  EIGEN_DEVICE_FUNC EIGEN_STRONG_INLINE TensorEvaluator(XprType& op,
                                                        const Device& device)
      : Base(op, device) {
    EIGEN_STATIC_ASSERT(
