...
template <typename XprType, template <class> class MakePointer_>
struct nested<TensorEvalToOp<XprType, MakePointer_>, 1,
              typename eval<TensorEvalToOp<XprType, MakePointer_> >::type> {
...
template <typename XprType, template <class> class MakePointer_>
class TensorEvalToOp : public TensorBase<TensorEvalToOp<XprType, MakePointer_>,
                                         ReadOnlyAccessors> {
 public:
  ...
  typedef
      typename Eigen::internal::traits<TensorEvalToOp>::StorageKind StorageKind;
  typedef typename Eigen::internal::traits<TensorEvalToOp>::Index Index;

  EIGEN_DEVICE_FUNC EIGEN_STRONG_INLINE TensorEvalToOp(PointerType buffer,
                                                       const XprType& expr)
...
struct TensorEvaluator<const TensorEvalToOp<ArgType, MakePointer_>, Device> {
  ...
  typedef
      typename internal::traits<const TensorEvalToOp<ArgType, MakePointer_> >::
