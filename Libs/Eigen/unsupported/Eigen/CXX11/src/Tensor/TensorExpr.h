...
class TensorCwiseNullaryOp
    : public TensorBase<TensorCwiseNullaryOp<NullaryOp, XprType>,
                        ReadOnlyAccessors> {
 public:
  ...
  typedef typename Eigen::internal::traits<TensorCwiseNullaryOp>::StorageKind
      StorageKind;
...
template <typename UnaryOp, typename XprType>
struct nested<TensorCwiseUnaryOp<UnaryOp, XprType>, 1,
              typename eval<TensorCwiseUnaryOp<UnaryOp, XprType> >::type> {
...
class TensorCwiseUnaryOp
    : public TensorBase<TensorCwiseUnaryOp<UnaryOp, XprType>,
                        ReadOnlyAccessors> {
 public:
  // TODO(phli): Add InputScalar, InputPacket.  Check references to
  // current Scalar/Packet to see if the intent is Input or Output.
  ...
  typedef typename Eigen::internal::traits<TensorCwiseUnaryOp>::StorageKind
      StorageKind;
...
struct traits<TensorCwiseBinaryOp<BinaryOp, LhsXprType, RhsXprType> > {
  ...
  typedef typename result_of<BinaryOp(
      typename LhsXprType::Scalar, typename RhsXprType::Scalar)>::type Scalar;
...
template <typename BinaryOp, typename LhsXprType, typename RhsXprType>
struct eval<TensorCwiseBinaryOp<BinaryOp, LhsXprType, RhsXprType>,
            Eigen::Dense> {
...
struct nested<TensorCwiseBinaryOp<BinaryOp, LhsXprType, RhsXprType>, 1,
              typename eval<TensorCwiseBinaryOp<BinaryOp, LhsXprType,
                                                RhsXprType> >::type> {
...
class TensorCwiseBinaryOp
    : public TensorBase<TensorCwiseBinaryOp<BinaryOp, LhsXprType, RhsXprType>,
                        ReadOnlyAccessors> {
 public:
  // TODO(phli): Add Lhs/RhsScalar, Lhs/RhsPacket.  Check references to
  // current Scalar/Packet to see if the intent is Inputs or Output.
  ...
  typedef typename Eigen::internal::traits<TensorCwiseBinaryOp>::StorageKind
      StorageKind;
  typedef typename Eigen::internal::traits<TensorCwiseBinaryOp>::Index Index;

  EIGEN_DEVICE_FUNC EIGEN_STRONG_INLINE
  TensorCwiseBinaryOp(const LhsXprType& lhs, const RhsXprType& rhs,
...
namespace internal {
template <typename TernaryOp, typename Arg1XprType, typename Arg2XprType,
          typename Arg3XprType>
struct traits<
    TensorCwiseTernaryOp<TernaryOp, Arg1XprType, Arg2XprType, Arg3XprType> > {
  // Type promotion to handle the case where the types of the args are
  // different.
  typedef typename result_of<TernaryOp(
      typename Arg1XprType::Scalar, typename Arg2XprType::Scalar,
...
struct eval<
    TensorCwiseTernaryOp<TernaryOp, Arg1XprType, Arg2XprType, Arg3XprType>,
    Eigen::Dense> {
  typedef const TensorCwiseTernaryOp<TernaryOp, Arg1XprType, Arg2XprType,
                                     Arg3XprType>& type;
};
...
template <typename TernaryOp, typename Arg1XprType, typename Arg2XprType,
          typename Arg3XprType>
struct nested<
    TensorCwiseTernaryOp<TernaryOp, Arg1XprType, Arg2XprType, Arg3XprType>, 1,
    typename eval<TensorCwiseTernaryOp<TernaryOp, Arg1XprType, Arg2XprType,
                                       Arg3XprType> >::type> {
  typedef TensorCwiseTernaryOp<TernaryOp, Arg1XprType, Arg2XprType, Arg3XprType>
      type;
};
...
class TensorCwiseTernaryOp
    : public TensorBase<TensorCwiseTernaryOp<TernaryOp, Arg1XprType,
                                             Arg2XprType, Arg3XprType>,
                        ReadOnlyAccessors> {
 public:
  ...
  typedef typename Eigen::internal::traits<TensorCwiseTernaryOp>::StorageKind
      StorageKind;
  ...
  EIGEN_DEVICE_FUNC EIGEN_STRONG_INLINE TensorCwiseTernaryOp(
      const Arg1XprType& arg1, const Arg2XprType& arg2, const Arg3XprType& arg3,
...
struct traits<TensorSelectOp<IfXprType, ThenXprType, ElseXprType> >
  ...
  typedef typename promote_storage_type<
      typename traits<ThenXprType>::StorageKind,
...
template <typename IfXprType, typename ThenXprType, typename ElseXprType>
struct nested<
    TensorSelectOp<IfXprType, ThenXprType, ElseXprType>, 1,
...
class TensorSelectOp
    : public TensorBase<TensorSelectOp<IfXprType, ThenXprType, ElseXprType>,
                        ReadOnlyAccessors> {
 public:
  ...
  typedef
      typename Eigen::internal::traits<TensorSelectOp>::StorageKind StorageKind;
  typedef typename Eigen::internal::traits<TensorSelectOp>::Index Index;

  EIGEN_DEVICE_FUNC
  TensorSelectOp(const IfXprType& a_condition, const ThenXprType& a_then,
