...
class TensorReshapingOp
 ...
 public:
  ...
  EIGEN_DEVICE_FUNC
  EIGEN_STRONG_INLINE TensorReshapingOp& operator=(
  ...
  EIGEN_DEVICE_FUNC EIGEN_STRONG_INLINE TensorReshapingOp& operator=(
...
class TensorSlicingOp
 ...
 public:
  ...
  template <typename OtherDerived>
  EIGEN_DEVICE_FUNC EIGEN_STRONG_INLINE TensorSlicingOp& operator=(
      const OtherDerived& other) {
  ...
  EIGEN_DEVICE_FUNC EIGEN_STRONG_INLINE bool evalSubExprsIfNeeded(
    ...
    if (!NumTraits<typename internal::remove_const<Scalar>::type>::
      ...
      if (trigger(contiguous_values)) {
        ...
        for (int i = 0; i < internal::array_prod(dimensions());
             i += contiguous_values) {
          Index offset = srcCoeff(i);
          m_device.memcpy((void*)(data + i), src + offset,
...
class TensorStridingSlicingOp
 ...
 public:
  ...
  EIGEN_DEVICE_FUNC
  EIGEN_STRONG_INLINE TensorStridingSlicingOp& operator=(
      const TensorStridingSlicingOp& other) {
    typedef TensorAssignOp<TensorStridingSlicingOp,
  ...
  template <typename OtherDerived>
  EIGEN_DEVICE_FUNC EIGEN_STRONG_INLINE TensorStridingSlicingOp& operator=(
      const OtherDerived& other) {
