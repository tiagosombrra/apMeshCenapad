...
struct CategoryCount<Arg, Args...> {
  static const size_t Count =
      LeafCount<Arg>::Count + CategoryCount<Args...>::Count;
};
...
// const TensorCwiseUnaryOp, const TensorCwiseNullaryOp, const
// TensorCwiseBinaryOp, const TensorCwiseTernaryOp, and Const
// TensorBroadcastingOp
template <template <class, class...> class CategoryExpr, typename OP,
          typename... RHSExpr>
struct LeafCount<const CategoryExpr<OP, RHSExpr...> >
    : CategoryCount<RHSExpr...> {};
// TensorCwiseUnaryOp,  TensorCwiseNullaryOp,  TensorCwiseBinaryOp,
// TensorCwiseTernaryOp, and  TensorBroadcastingOp
template <template <class, class...> class CategoryExpr, typename OP,
          typename... RHSExpr>
...
/// specialisation of the \ref LeafCount struct when the node type is const
/// TensorSelectOp is an exception
...
struct LeafCount<const TensorSelectOp<IfExpr, ThenExpr, ElseExpr> >
    : CategoryCount<IfExpr, ThenExpr, ElseExpr> {};
...
struct LeafCount<TensorEvalToOp<Expr> >
    : LeafCount<const TensorEvalToOp<Expr> > {};
