...
/** \ingroup Polynomials_Module
 * \returns the evaluation of the polynomial at x using stabilized Horner
 * algorithm.
 *
 * \param[in] poly : the vector of coefficients of the polynomial ordered
 *  by degrees i.e. poly[i] is the coefficient of degree i of the polynomial
...
/** \ingroup Polynomials_Module
 * \returns a maximum bound for the absolute value of any root of the
 * polynomial.
 *
 * \param[in] poly : the vector of coefficients of the polynomial ordered
 *  by degrees i.e. poly[i] is the coefficient of degree i of the polynomial
...
inline typename NumTraits<typename Polynomial::Scalar>::Real cauchy_max_bound(
...
/** \ingroup Polynomials_Module
 * \returns a minimum bound for the absolute value of any non zero root of the
 * polynomial. \param[in] poly : the vector of coefficients of the polynomial
 * ordered by degrees i.e. poly[i] is the coefficient of degree i of the
 * polynomial e.g. \f$ 1 + 3x^2 \f$ is stored as a vector \f$ [ 1, 0, 3 ] \f$.
 */
template <typename Polynomial>
inline typename NumTraits<typename Polynomial::Scalar>::Real cauchy_min_bound(
    const Polynomial& poly) {
  using std::abs;
  typedef typename Polynomial::Scalar Scalar;
  typedef typename NumTraits<Scalar>::Real Real;
