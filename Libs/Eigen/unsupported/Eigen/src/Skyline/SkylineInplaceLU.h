...
class SkylineInplaceLU {
 ...
 public:
  /** Creates a LU object and compute the respective factorization of \a matrix
   * using flags \a flags. */
  ...
  /** Sets the relative threshold value used to prune zero coefficients during
   * the decomposition.
   *
   * Setting a value greater than zero speeds up computation, and yields to an
   * imcomplete factorization with fewer non zero coefficients. Such approximate
   * factors are especially useful to initialize an iterative solver.
   *
