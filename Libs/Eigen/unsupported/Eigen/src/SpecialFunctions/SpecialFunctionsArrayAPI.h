 ...
 * user has to provide implementations of igammac(T,T) for any scalar type T to
 * be supported.
 *
 ...
 * \note This function supports only float and double scalar types in c++11
 * mode. To support other scalar types, or float/double in non c++11 mode, the
 * user has to provide implementations of polygamma(T,T) for any scalar type T
 * to be supported.
 *
 * \sa Eigen::digamma()
 */
 ...
 * \note This function supports only float and double scalar types in c++11
 * mode. To support other scalar types, or float/double in non c++11 mode, the
 * user has to provide implementations of betainc(T,T,T) for any scalar type T
 * to be supported.
 *
