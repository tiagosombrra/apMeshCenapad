...
bool Adjacente::confirmaEsq ( const Noh& noh, const Elemento& P, const Elemento& U)
{
    ...
    {
        if (
                (	(	P.getN ( 1 ) == U.getN ( 1 ) ) and
                    (	P.getN ( 3 ) == U.getN ( 2 ) ) ) or

                (	(	P.getN ( 1 ) == U.getN ( 3 ) ) and
                    (	P.getN ( 3 ) == U.getN ( 1 ) ) ) or

                (	(	P.getN ( 1 ) == U.getN ( 2 ) ) and
                    (	P.getN ( 3 ) == U.getN ( 3 ) ) )
                ) return true;
    }
    ...
    {
        if (
                (	(	P.getN ( 2 ) == U.getN ( 1 ) ) and
                    (	P.getN ( 1 ) == U.getN ( 2 ) ) ) or

                (	(	P.getN ( 2 ) == U.getN ( 3 ) ) and
                    (	P.getN ( 1 ) == U.getN ( 1 ) ) ) or

                (	(	P.getN ( 2 ) == U.getN ( 2 ) ) and
                    (	P.getN ( 1 ) == U.getN ( 3 ) ) )
                ) return true;
    }
    ...
    {
        if (
                (	(	P.getN ( 3 ) == U.getN ( 1 ) ) and
                    (	P.getN ( 2 ) == U.getN ( 2 ) ) ) or

                (	(	P.getN ( 3 ) == U.getN ( 3 ) ) and
                    (	P.getN ( 2 ) == U.getN ( 1 ) ) ) or

                (	(	P.getN ( 3 ) == U.getN ( 2 ) ) and
                    (	P.getN ( 2 ) == U.getN ( 3 ) ) )
                ) return true;
    }
...
bool Adjacente::confirmaDir ( const Noh& noh, const Elemento& P, const Elemento& U)
{
    ...
    {
        if (
                (	(	U.getN ( 1 ) == P.getN ( 1 ) ) and
                    (	U.getN ( 3 ) == P.getN ( 2 ) ) ) or

                (	(	U.getN ( 3 ) == P.getN ( 1 ) ) and
                    (	U.getN ( 2 ) == P.getN ( 2 ) ) ) or

                (	(	U.getN ( 2 ) == P.getN ( 1 ) ) and
                    (	U.getN ( 1 ) == P.getN ( 2 ) ) )
                ) return true;
    }
    ...
    {
        if (
                (	(	U.getN ( 1 ) == P.getN ( 2 ) ) and
                    (	U.getN ( 3 ) == P.getN ( 3 ) ) ) or

                (	(	U.getN ( 3 ) == P.getN ( 2 ) ) and
                    (	U.getN ( 2 ) == P.getN ( 3 ) ) ) or

                (	(	U.getN ( 2 ) == P.getN ( 2 ) ) and
                    (	U.getN ( 1 ) == P.getN ( 3 ) ) )
                ) return true;
    }
    ...
    {
        if (
                (	(	U.getN ( 1 ) == P.getN ( 3 ) ) and
                    (	U.getN ( 3 ) == P.getN ( 1 ) ) ) or

                (	(	U.getN ( 3 ) == P.getN ( 3 ) ) and
                    (	U.getN ( 2 ) == P.getN ( 1 ) ) ) or

                (	(	U.getN ( 2 ) == P.getN ( 3 ) ) and
                    (	U.getN ( 1 ) == P.getN ( 1 ) ) )
                ) return true;
    }
