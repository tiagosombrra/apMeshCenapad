...
double CurvaParametrica::calcularCurvatura(double)
{
    return -1;
}
...
Matrix4x1 CurvaParametrica::getGx() const {
    return this->Gx;
}

Matrix4x1 CurvaParametrica::getGy() const {
    return this->Gy;
}

Matrix4x1 CurvaParametrica::getGz() const {
    return this->Gz;
}

Matrix4x4 CurvaParametrica::getM() const {
    return this->M;
}

Matrix1x4 CurvaParametrica::getT() const {
    return this->T;
}
...
void CurvaParametrica::setGx(Matrix4x1 &G_x){
    this->Gx = G_x;
}

void CurvaParametrica::setGy(Matrix4x1 &G_y){
    this->Gy = G_y;
}

void CurvaParametrica::setGz(Matrix4x1 &G_z){
    this->Gz = G_z;
}

void CurvaParametrica::setM(Matrix4x4 &M_){
    this->M = M_;
}

void CurvaParametrica::setT(Matrix1x4 &T_){
    this->T = T_;
}
...
CurvaParametrica::CurvaParametrica ( CurvaParametrica* antiga ) :
    Curva ( antiga )
{
    this->P0 = antiga->P0;
    this->P1 = antiga->P1;
