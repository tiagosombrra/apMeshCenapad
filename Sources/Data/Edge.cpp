...
Vertex *Edge::makeMid()
{
    ...
    {
        v->setPosition((this->v[0]->getX() + this->v[1]->getX())/2.0, (this->v[0]->getY() + this->v[1]->getY())/2.0);
    }
...
Vertex *Edge::makeVector()
{
    ...
    if (this->v[0] && this->v[1])
    {
        v->setPosition(this->v[1]->getX() - this->v[0]->getX(), this->v[1]->getY() - this->v[0]->getY());
    }
...
void Edge::setInBoundary(bool inBoundary)
{
    this->inBoundary = inBoundary;
}

bool Edge::isInBoundary()
{
    return inBoundary;
}
...
void Edge::setCell(QuadtreeCell *cell)
{
    this->cell = cell;
}

QuadtreeCell *Edge::getCell()
{
    return cell;
}
...
Vertex *Edge::normal()
{
    ...
    {
        normal->setPosition(v[0]->getY() - v[1]->getY(), v[1]->getX() - v[0]->getX());
