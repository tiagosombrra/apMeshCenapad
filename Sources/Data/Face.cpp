...
void Face::setV1(Vertex *v)
{
    this->v[0] = v;
}

void Face::setV2(Vertex *v)
{
    this->v[1] = v;
}

void Face::setV3(Vertex *v)
{
    this->v[2] = v;
}
...
string Face::getText()
{
    ...
    stream << id << " " << v[0]->getId() << " " << v[1]->getId() << " " << v[2]->getId();
