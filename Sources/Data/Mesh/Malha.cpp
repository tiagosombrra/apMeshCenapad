...
void Malha::insereSubMalha(SubMalha* sub) { this->subMalhas.push_back(sub); }

void Malha::removeSubMalha() { this->subMalhas.pop_back(); }
...
void Malha::resizeSubmalha(Data::Int pos) { this->subMalhas.resize(pos, NULL); }
