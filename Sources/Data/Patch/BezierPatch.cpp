...
void BezierPatch::mostraMatrizes() {
  ...
  //  0, 3 ) << endl;
  cout << "B:\n" << B;
  //            this->getB().getElement( 0, 0 ) <<" "<< this->getB().getElement(
  //            0, 1 ) <<" "<< this->getB().getElement( 0, 2 ) <<" "<<
  //            this->getB().getElement( 0, 3 ) << "\n" <<
  //            this->getB().getElement( 1, 0 ) <<" "<< this->getB().getElement(
  //            1, 1 ) <<" "<< this->getB().getElement( 1, 2 ) <<" "<<
  //            this->getB().getElement( 1, 3 ) << "\n" <<
  //            this->getB().getElement( 2, 0 ) <<" "<< this->getB().getElement(
  //            2, 1 ) <<" "<< this->getB().getElement( 2, 2 ) <<" "<<
  //            this->getB().getElement( 2, 3 ) << "\n" <<
  //            this->getB().getElement( 3, 0 ) <<" "<< this->getB().getElement(
  //            3, 1 ) <<" "<< this->getB().getElement( 3, 2 ) <<" "<<
  //            this->getB().getElement( 3, 3 ) << endl;

  cout << "Gx:\n" << Gx;
  //            this->getGx().getElement( 0, 0 ) <<" "<<
  //            this->getGx().getElement( 0, 1 ) <<" "<<
  //            this->getGx().getElement( 0, 2 ) <<" "<<
  //            this->getGx().getElement( 0, 3 ) << "\n" <<
  //            this->getGx().getElement( 1, 0 ) <<" "<<
  //            this->getGx().getElement( 1, 1 ) <<" "<<
  //            this->getGx().getElement( 1, 2 ) <<" "<<
  //            this->getGx().getElement( 1, 3 ) << "\n" <<
  //            this->getGx().getElement( 2, 0 ) <<" "<<
  //            this->getGx().getElement( 2, 1 ) <<" "<<
  //            this->getGx().getElement( 2, 2 ) <<" "<<
  //            this->getGx().getElement( 2, 3 ) << "\n" <<
  //            this->getGx().getElement( 3, 0 ) <<" "<<
  //            this->getGx().getElement( 3, 1 ) <<" "<<
  //            this->getGx().getElement( 3, 2 ) <<" "<<
  //            this->getGx().getElement( 3, 3 ) << endl;

  cout << "Gy:\n" << Gy;
  //            this->getGy().getElement( 0, 0 ) <<" "<<
  //            this->getGy().getElement( 0, 1 ) <<" "<<
  //            this->getGy().getElement( 0, 2 ) <<" "<<
  //            this->getGy().getElement( 0, 3 ) << "\n" <<
  //            this->getGy().getElement( 1, 0 ) <<" "<<
  //            this->getGy().getElement( 1, 1 ) <<" "<<
  //            this->getGy().getElement( 1, 2 ) <<" "<<
  //            this->getGy().getElement( 1, 3 ) << "\n" <<
  //            this->getGy().getElement( 2, 0 ) <<" "<<
  //            this->getGy().getElement( 2, 1 ) <<" "<<
  //            this->getGy().getElement( 2, 2 ) <<" "<<
  //            this->getGy().getElement( 2, 3 ) << "\n" <<
  //            this->getGy().getElement( 3, 0 ) <<" "<<
  //            this->getGy().getElement( 3, 1 ) <<" "<<
  //            this->getGy().getElement( 3, 2 ) <<" "<<
  //            this->getGy().getElement( 3, 3 ) << endl;

  cout << "Gz:\n" << Gz;
  //            this->getGz().getElement( 0, 0 ) <<" "<<
  //            this->getGz().getElement( 0, 1 ) <<" "<<
  //            this->getGz().getElement( 0, 2 ) <<" "<<
  //            this->getGz().getElement( 0, 3 ) << "\n" <<
  //            this->getGz().getElement( 1, 0 ) <<" "<<
  //            this->getGz().getElement( 1, 1 ) <<" "<<
  //            this->getGz().getElement( 1, 2 ) <<" "<<
  //            this->getGz().getElement( 1, 3 ) << "\n" <<
  //            this->getGz().getElement( 2, 0 ) <<" "<<
  //            this->getGz().getElement( 2, 1 ) <<" "<<
  //            this->getGz().getElement( 2, 2 ) <<" "<<
  //            this->getGz().getElement( 2, 3 ) << "\n" <<
  //            this->getGz().getElement( 3, 0 ) <<" "<<
  //            this->getGz().getElement( 3, 1 ) <<" "<<
...
// derivadas parciais
Matrix1x4 BezierPatch::getU() const { return this->U; }

Matrix4x4 BezierPatch::getGx() const { return this->Gx; }

Matrix4x4 BezierPatch::getGy() const { return this->Gy; }

Matrix4x4 BezierPatch::getGz() const { return this->Gz; }

Matrix4x1 BezierPatch::getV() const { return this->V; }

Matrix4x4 BezierPatch::getB() const { return this->B; }
...
Ponto BezierPatch::calculaPonto_u_v() {
  ...
  C.x = (this->getU() *
         (  // this->getB  ( ) *
             (this->getGx() *
              (  // this->getB  ( ) *   // só é getB ao invés de
                 // getB().transposta pois a matriz de Bezier é simétrica
                  this->getV()))))(0, 0);
...
Ponto BezierPatch::getPt00() const { return this->Pt00; }

Ponto BezierPatch::getPt01() const { return this->Pt01; }

Ponto BezierPatch::getPt02() const { return this->Pt02; }

Ponto BezierPatch::getPt03() const { return this->Pt03; }

Ponto BezierPatch::getPt10() const { return this->Pt10; }

Ponto BezierPatch::getPt11() const { return this->Pt11; }

Ponto BezierPatch::getPt12() const { return this->Pt12; }

Ponto BezierPatch::getPt13() const { return this->Pt13; }

Ponto BezierPatch::getPt20() const { return this->Pt20; }

Ponto BezierPatch::getPt21() const { return this->Pt21; }

Ponto BezierPatch::getPt22() const { return this->Pt22; }

Ponto BezierPatch::getPt23() const { return this->Pt23; }

Ponto BezierPatch::getPt30() const { return this->Pt30; }

Ponto BezierPatch::getPt31() const { return this->Pt31; }

Ponto BezierPatch::getPt32() const { return this->Pt32; }

Ponto BezierPatch::getPt33() const { return this->Pt33; }

void BezierPatch::setPt00(Ponto value) { Pt00 = value; }

void BezierPatch::setPt01(Ponto value) { Pt01 = value; }

void BezierPatch::setPt02(Ponto value) { Pt02 = value; }

void BezierPatch::setPt03(Ponto value) { Pt03 = value; }

void BezierPatch::setPt10(Ponto value) { Pt10 = value; }

void BezierPatch::setPt11(Ponto value) { Pt11 = value; }

void BezierPatch::setPt12(Ponto value) { Pt12 = value; }

void BezierPatch::setPt13(Ponto value) { Pt13 = value; }

void BezierPatch::setPt20(Ponto value) { Pt20 = value; }

void BezierPatch::setPt21(Ponto value) { Pt21 = value; }

void BezierPatch::setPt22(Ponto value) { Pt22 = value; }

void BezierPatch::setPt23(Ponto value) { Pt23 = value; }

void BezierPatch::setPt30(Ponto value) { Pt30 = value; }

void BezierPatch::setPt31(Ponto value) { Pt31 = value; }

void BezierPatch::setPt32(Ponto value) { Pt32 = value; }

void BezierPatch::setPt33(Ponto value) { Pt33 = value; }
...
Vetor BezierPatch::Qvu(double u, double v) { return Quv(u, v); }
...
BezierPatch::BezierPatch(BezierPatch* antigo) : CoonsPatch(antigo) {
  this->Pt03 = antigo->Pt03;
  this->Pt13 = antigo->Pt13;
  this->Pt23 = antigo->Pt23;
  this->Pt33 = antigo->Pt33;
  this->Pt02 = antigo->Pt02;
  this->Pt12 = antigo->Pt12;
  this->Pt22 = antigo->Pt22;
  this->Pt32 = antigo->Pt32;
  this->Pt01 = antigo->Pt01;
  this->Pt11 = antigo->Pt11;
  this->Pt21 = antigo->Pt21;
  this->Pt31 = antigo->Pt31;
  this->Pt00 = antigo->Pt00;
  this->Pt10 = antigo->Pt10;
  this->Pt20 = antigo->Pt20;
  this->Pt30 = antigo->Pt30;
...
double BezierPatch::getNumberTriangle() const { return NumberTriangle; }

void BezierPatch::setNumberTriangle(double value) { NumberTriangle = value; }
double BezierPatch::getAreaTriangle() const { return areaTriangle; }

void BezierPatch::setAreaTriangle(double value) { areaTriangle = value; }

double BezierPatch::getSegmentMedio() const { return segmentMedio; }

void BezierPatch::setSegmentMedio(double value) { segmentMedio = value; }

double BezierPatch::getKaMedio() const { return kaMedio; }

void BezierPatch::setKaMedio(double value) { kaMedio = value; }

double BezierPatch::getArea() const { return area; }

void BezierPatch::setArea(double value) { area = value; }

int BezierPatch::getIdProcess() const { return idProcess; }

void BezierPatch::setIdProcess(int value) { idProcess = value; }

int BezierPatch::getId_bezierPatch() const { return id_bezierPatch; }

void BezierPatch::setId_bezierPatch(int value) { id_bezierPatch = value; }
