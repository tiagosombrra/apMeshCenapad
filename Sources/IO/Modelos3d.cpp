...
Geometria *Modelos3d::modelParaboloide(Geometria *geo){
    ...
    Vetor* patch1_Qu10 = new Vetor ( patch1_Qu00->x,-patch1_Qu00->y,-patch1_Qu00->z );
    Vetor* patch1_Qu01 = new Vetor ( 1.0, 0.0, 18.25 );
    Vetor* patch1_Qu11 = new Vetor ( patch1_Qu01->x,-patch1_Qu01->y,-patch1_Qu01->z );

    Vetor* patch1_Qv00 = new Vetor ( 0.0, 1.0,-18.25 );
    Vetor* patch1_Qv10 = new Vetor ( 0.0, 1.0,-18.25 );
    Vetor* patch1_Qv01 = new Vetor (-patch1_Qv00->x, patch1_Qv00->y,-patch1_Qv00->z );
    Vetor* patch1_Qv11 = new Vetor (-patch1_Qv10->x, patch1_Qv10->y,-patch1_Qv10->z );
    ...
    Curva* patch1_c1 = new CurvParamHermite ( *patch1_p00, *patch1_p10, *patch1_Qu00, *patch1_Qu10 );
    Curva* patch1_c2 = new CurvParamHermite ( *patch1_p10, *patch1_p11, *patch1_Qv10, *patch1_Qv11 );
    Curva* patch1_c3 = new CurvParamHermite ( *patch1_p01, *patch1_p11, *patch1_Qu01, *patch1_Qu11 );
    Curva* patch1_c4 = new CurvParamHermite ( *patch1_p00, *patch1_p01, *patch1_Qv00, *patch1_Qv01 );

    Patch* patch1 = new HermitePatch (	patch1_c1, patch1_c2, patch1_c3, patch1_c4,
                                        *patch1_tw00, *patch1_tw10, *patch1_tw01, *patch1_tw11 );
...
Geometria *Modelos3d::modelPneu(Geometria *geo){
    ...
    Patch* patch2 = new HermitePatch ( c5, c4, c6, c2, *tw_00, *tw_10, *tw_01, *tw_11 );
...
Geometria *Modelos3d::modelDoisPatches(Geometria *geo){
    ...
    Patch* patch1 = new HermitePatch ( c1, c2, c3, c4, *tw100, *tw110, *tw101, *tw111 );
    Patch* patch2 = new HermitePatch ( c5, c6, c7, c2, *tw200, *tw210, *tw201, *tw211 );
...
Geometria *Modelos3d::modelNariz(Geometria *geo){
    ...
    Vetor* patch2_Qv10 = new Vetor (-patch1_Qv10->x, patch1_Qv10->y, patch1_Qv10->z );
    //Vetor* patch2_Qv01 = new Vetor ( *patch2_p00, *patch2_p01 );
    Vetor* patch2_Qv11 = new Vetor (-patch1_Qv11->x, patch1_Qv11->y, patch1_Qv11->z );
    ...
    Curva* patch2_c1 = new CurvParamHermite ( *patch2_p00, *patch2_p10, *patch2_Qu00, *patch2_Qu10 );
    Curva* patch2_c2 = new CurvParamHermite ( *patch2_p10, *patch2_p11, *patch2_Qv10, *patch2_Qv11 );
    Curva* patch2_c3 = new CurvParamHermite ( *patch2_p01, *patch2_p11, *patch2_Qu01, *patch2_Qu11 );
    Curva* patch2_c4 = patch1_c2;

    Patch* patch2 = new HermitePatch (	patch2_c1, patch2_c2, patch2_c3, patch2_c4,
                                        *patch2_tw00, *patch2_tw10, *patch2_tw01, *patch2_tw11 );
    ...
    Vetor* patch3_Qu00 = new Vetor ( -(-(*patch1_Qu10)).x, (-(*patch1_Qu10)).y, (-(*patch1_Qu10)).z );
    Vetor* patch3_Qu10 = new Vetor ( -(-(*patch1_Qu00)).x, (-(*patch1_Qu00)).y, (-(*patch1_Qu00)).z );
    Vetor* patch3_Qu01 = new Vetor ( -(-(*patch1_Qu11)).x, (-(*patch1_Qu11)).y, (-(*patch1_Qu11)).z );
    Vetor* patch3_Qu11 = new Vetor ( -(-(*patch1_Qu01)).x, (-(*patch1_Qu01)).y, (-(*patch1_Qu01)).z );

    //Vetor* patch3_Qv00 = new Vetor ( -patch1_Qv10->x, patch1_Qv10->y, patch1_Qv10->z );
    Vetor* patch3_Qv10 = new Vetor ( -patch1_Qv00->x, patch1_Qv00->y, patch1_Qv00->z );
    //Vetor* patch3_Qv01 = new Vetor ( -patch1_Qv11->x, patch1_Qv11->y, patch1_Qv11->z );
    Vetor* patch3_Qv11 = new Vetor ( -patch1_Qv01->x, patch1_Qv01->y, patch1_Qv01->z );

    Vetor* patch3_tw00 = new Vetor ( patch1_tw00->x, patch1_tw00->y, patch1_tw00->z );
    Vetor* patch3_tw10 = new Vetor ( patch1_tw10->x, patch1_tw10->y, patch1_tw10->z );
    Vetor* patch3_tw01 = new Vetor ( patch1_tw01->x, patch1_tw01->y, patch1_tw01->z );
    Vetor* patch3_tw11 = new Vetor ( patch1_tw11->x, patch1_tw11->y, patch1_tw11->z );

    Curva* patch3_c1 = new CurvParamHermite ( *patch3_p00, *patch3_p10, *patch3_Qu00, *patch3_Qu10 );
    Curva* patch3_c2 = new CurvParamHermite ( *patch3_p10, *patch3_p11, *patch3_Qv10, *patch3_Qv11 );
    Curva* patch3_c3 = new CurvParamHermite ( *patch3_p01, *patch3_p11, *patch3_Qu01, *patch3_Qu11 );
    Curva* patch3_c4 = patch2_c2;

    Patch* patch3 = new HermitePatch (	patch3_c1, patch3_c2, patch3_c3, patch3_c4,
                                        *patch3_tw00, *patch3_tw10, *patch3_tw01, *patch3_tw11 );
    ...
    Curva* patch4_c2 = new CurvParamHermite ( *patch4_p10, *patch4_p11, *patch4_Qv10, *patch4_Qv11 );
    Curva* patch4_c3 = new CurvParamHermite ( *patch4_p01, *patch4_p11, *patch4_Qu01, *patch4_Qu11 );
    Curva* patch4_c4 = new CurvParamHermite ( *patch4_p00, *patch4_p01, *patch4_Qv00, *patch4_Qv01 );

    Patch* patch4 = new HermitePatch (	patch4_c1, patch4_c2, patch4_c3, patch4_c4,
                                        *patch4_tw00, *patch4_tw10, *patch4_tw01, *patch4_tw11 );
    ...
    Vetor* patch5_Qu01 = new Vetor ( patch4_Qu11->x, patch4_Qu11->y, patch4_Qu11->z );
    Vetor* patch5_Qu11 = new Vetor ( patch5_Qu01->x,-patch5_Qu01->y,-patch5_Qu01->z );

    //Vetor* patch5_Qv00 = new Vetor ( *patch5_p00, *patch5_p01 );
    Vetor* patch5_Qv10 = new Vetor (-patch4_Qv10->x, patch4_Qv10->y, patch4_Qv10->z );
    //Vetor* patch5_Qv01 = new Vetor ( *patch5_p00, *patch5_p01 );
    Vetor* patch5_Qv11 = new Vetor (-patch4_Qv11->x, patch4_Qv11->y, patch4_Qv11->z );
    ...
    Curva* patch5_c2 = new CurvParamHermite ( *patch5_p10, *patch5_p11, *patch5_Qv10, *patch5_Qv11 );
    Curva* patch5_c3 = new CurvParamHermite ( *patch5_p01, *patch5_p11, *patch5_Qu01, *patch5_Qu11 );
    Curva* patch5_c4 = patch4_c2;

    Patch* patch5 = new HermitePatch (	patch5_c1, patch5_c2, patch5_c3, patch5_c4,
                                        *patch5_tw00, *patch5_tw10, *patch5_tw01, *patch5_tw11 );
    ...
    //Vetor* patch6_Qu00 = new Vetor ( patch5_Qu11->x, patch5_Qu11->y, patch5_Qu11->z );
    //Vetor* patch6_Qu10 = new Vetor ( patch6_Qu00->x,-patch6_Qu00->y,-patch6_Qu00->z );
    Vetor* patch6_Qu01 = new Vetor ( patch4_Qu11->x,-patch4_Qu11->y,-patch4_Qu11->z );
    Vetor* patch6_Qu11 = new Vetor ( patch4_Qu01->x,-patch4_Qu01->y,-patch4_Qu01->z );

    //Vetor* patch6_Qv00 = new Vetor ( *patch6_p00, *patch6_p01 );
    Vetor* patch6_Qv10 = new Vetor (-patch4_Qv00->x, patch4_Qv00->y, patch4_Qv00->z );
    //Vetor* patch6_Qv01 = new Vetor ( *patch6_p00, *patch6_p01 );
    Vetor* patch6_Qv11 = new Vetor (-patch4_Qv01->x, patch4_Qv01->y, patch4_Qv01->z );
    ...
    Curva* patch6_c2 = new CurvParamHermite ( *patch6_p10, *patch6_p11, *patch6_Qv10, *patch6_Qv11 );
    Curva* patch6_c3 = new CurvParamHermite ( *patch6_p01, *patch6_p11, *patch6_Qu01, *patch6_Qu11 );
    Curva* patch6_c4 = patch5_c2;

    Patch* patch6 = new HermitePatch (	patch6_c1, patch6_c2, patch6_c3, patch6_c4,
                                        *patch6_tw00, *patch6_tw10, *patch6_tw01, *patch6_tw11 );
    ...
    //Vetor* patch8_Qu00 = new Vetor ( patch4_Qu11->x, patch4_Qu11->y, patch4_Qu11->z );
    //Vetor* patch8_Qu10 = new Vetor ( patch5_Qu01->x,-patch5_Qu01->y,-patch5_Qu01->z );
    Vetor* patch8_Qu01 = new Vetor ( 5.0, -3.5, 3.5 );
    Vetor* patch8_Qu11 = new Vetor ( patch8_Qu01->x,-patch8_Qu01->y,-patch8_Qu01->z );
    ...
    Curva* patch8_c2 = new CurvParamHermite ( *patch8_p10, *patch8_p11, *patch8_Qv10, *patch8_Qv11 );
    Curva* patch8_c3 = new CurvParamHermite ( *patch8_p01, *patch8_p11, *patch8_Qu01, *patch8_Qu11 );
    Curva* patch8_c4 = new CurvParamHermite ( *patch8_p00, *patch8_p01, *patch8_Qv00, *patch8_Qv01 );

    Patch* patch8 = new HermitePatch (	patch8_c1, patch8_c2, patch8_c3, patch8_c4,
                                        *patch8_tw00, *patch8_tw10, *patch8_tw01, *patch8_tw11 );
    ...
    Curva* patch10_c2 = new CurvParamHermite ( *patch10_p10, *patch10_p11, *patch10_Qv10, *patch10_Qv11 );
    Curva* patch10_c3 = new CurvParamHermite ( *patch10_p01, *patch10_p11, *patch10_Qu01, *patch10_Qu11 );
    Curva* patch10_c4 = new CurvParamHermite ( *patch10_p00, *patch10_p01, *patch10_Qv00, *patch10_Qv01 );

    Patch* patch10 = new HermitePatch (	patch10_c1, patch10_c2, patch10_c3, patch10_c4,
                                        *patch10_tw00, *patch10_tw10, *patch10_tw01, *patch10_tw11 );
    ...
    Vetor* patch7_Qv01 = new Vetor ( -patch7_Qv00->x, patch7_Qv00->y, -patch7_Qv00->z );
    ...
    Curva* patch7_c3 = new CurvParamHermite ( *patch7_p01, *patch7_p11, *patch7_Qu01, *patch7_Qu11 );
    Curva* patch7_c4 = new CurvParamHermite ( *patch7_p00, *patch7_p01, *patch7_Qv00, *patch7_Qv01 );

    Patch* patch7 = new HermitePatch (	patch7_c1, patch7_c2, patch7_c3, patch7_c4,
                                        *patch7_tw00, *patch7_tw10, *patch7_tw01, *patch7_tw11 );
    ...
    Vetor* patch9_Qv10 = new Vetor (-patch7_Qv00->x, patch7_Qv00->y, patch7_Qv00->z );
    //Vetor* patch9_Qv01 = new Vetor ( *patch9_p00, *patch9_p01 );
    Vetor* patch9_Qv11 = new Vetor (-patch9_Qv10->x, patch9_Qv10->y,-patch9_Qv10->z );
    ...
    Curva* patch9_c2 = new CurvParamHermite ( *patch9_p10, *patch9_p11, *patch9_Qv10, *patch9_Qv11 );
    Curva* patch9_c3 = patch10_c2;
    Curva* patch9_c4 = patch8_c2;

    Patch* patch9 = new HermitePatch (	patch9_c1, patch9_c2, patch9_c3, patch9_c4,
                                        *patch9_tw00, *patch9_tw10, *patch9_tw01, *patch9_tw11 );
    ...
    Curva* patch11_c3 = new CurvParamHermite ( *patch11_p01, *patch11_p11, *patch11_Qu01, *patch11_Qu11 );
    Curva* patch11_c4 = new CurvParamHermite ( *patch11_p00, *patch11_p01, *patch11_Qv00, *patch11_Qv01 );

    Patch* patch11 = new HermitePatch (	patch11_c1, patch11_c2, patch11_c3, patch11_c4,
                                        *patch11_tw00, *patch11_tw10, *patch11_tw01, *patch11_tw11 );
    ...
    Ponto* patch12_p10 = new Vertice ( -patch11_p01->x, patch11_p01->y, patch11_p01->z );
    ...
    Curva* patch12_c1 = new CurvParamHermite ( *patch12_p00, *patch12_p10, *patch12_Qu00, *patch12_Qu10 );
    Curva* patch12_c2 = new CurvParamHermite ( *patch12_p10, *patch12_p11, *patch12_Qv10, *patch12_Qv11 );
    Curva* patch12_c3 = patch6_c2;
    Curva* patch12_c4 = patch3_c2;

    Patch* patch12 = new HermitePatch (	patch12_c1, patch12_c2, patch12_c3, patch12_c4,
                                        *patch12_tw00, *patch12_tw10, *patch12_tw01, *patch12_tw11 );
    ...
    Curva* patch13_c3 = new CurvParamHermite ( *patch13_p01, *patch13_p11, *patch13_Qu01, *patch13_Qu11 );
    Curva* patch13_c4 = new CurvParamHermite ( *patch13_p00, *patch13_p01, *patch13_Qv00, *patch13_Qv01 );

    Patch* patch13 = new HermitePatch (	patch13_c1, patch13_c2, patch13_c3, patch13_c4,
                                        *patch13_tw00, *patch13_tw10, *patch13_tw01, *patch13_tw11 );
    ...
    Ponto* patch14_p10 = new Vertice ( -patch13_p01->x, patch13_p01->y, patch13_p01->z );
    ...
    Curva* patch14_c1 = new CurvParamHermite ( *patch14_p00, *patch14_p10, *patch14_Qu00, *patch14_Qu10 );
    Curva* patch14_c2 = new CurvParamHermite ( *patch14_p10, *patch14_p11, *patch14_Qv10, *patch14_Qv11 );
    Curva* patch14_c3 = patch9_c2;
    Curva* patch14_c4 = patch12_c2;

    Patch* patch14 = new HermitePatch (	patch14_c1, patch14_c2, patch14_c3, patch14_c4,
                                        *patch14_tw00, *patch14_tw10, *patch14_tw01, *patch14_tw11 );
...
Geometria *Modelos3d::modelUtahteapot(Geometria *geo){
    ...
    Curva* patch2_c1 = new CurvParamBezier ( *p130, *p210, *p220, *p230 ); //( *p200, *p210, *p220, *p230 );
    Curva* patch2_c2 = new CurvParamBezier ( *p230, *p231, *p232, *p233 );
    Curva* patch2_c3 = new CurvParamBezier ( *p133, *p213, *p223, *p233 );
    //Curva* patch2_c4 = patch1_c2; //new CurvParamBezier ( *p130, *p131, *p132, *p133 ); //( *p200, *p201, *p202, *p203 );
    ...
    Curva* patch4_c1 = new CurvParamBezier ( *p330, *p410, *p420, *p100 ); // ( *p400, *p410, *p420, *p430 );
    //Curva* patch4_c2 = new CurvParamBezier ( *p100, *p101, *p102, *p103 ); // ( *p430, *p431, *p432, *p433 );
    Curva* patch4_c3 = new CurvParamBezier ( *p333, *p413, *p423, *p103 ); // ( *p403, *p413, *p423, *p433 );
    //Curva* patch4_c4 = new CurvParamBezier ( *p330, *p331, *p332, *p333 ); // ( *p400, *p401, *p402, *p403 );
    ...
    //Curva* patch5_c1 = patch1_c3; //new CurvParamBezier ( *p103, *p113, *p123, *p133 ); // ( *p500, *p510, *p520, *p530 );
    Curva* patch5_c2 = new CurvParamBezier ( *p133, *p531, *p532, *p533 ); // ( *p530, *p531, *p532, *p533 );
    Curva* patch5_c3 = new CurvParamBezier ( *p503, *p513, *p523, *p533 ); // ( *p503, *p513, *p523, *p533 );
    Curva* patch5_c4 = new CurvParamBezier ( *p103, *p501, *p502, *p503 ); // ( *p500, *p501, *p502, *p503 );
    ...
    //		Curva* patch6_c1 = new CurvParamBezier ( *p133, *p213, *p223, *p233 ); // ( *p600, *p610, *p620, *p630 );
    Curva* patch6_c2 = new CurvParamBezier ( *p233, *p631, *p632, *p633 ); // ( *p630, *p631, *p632, *p633 );
    Curva* patch6_c3 = new CurvParamBezier ( *p533, *p613, *p623, *p633 ); // ( *p603, *p613, *p623, *p633 );
    //		Curva* patch6_c4 = new CurvParamBezier ( *p133, *p531, *p532, *p533 ); // ( *p600, *p601, *p602, *p603 );
    ...
    //		Curva* patch11_c4 = new CurvParamBezier ( *p633, *p1031, *p1032, *p1033 );

    Patch* patch11 = new BezierPatch (	patch7_c3, patch11_c2, patch11_c3, patch10_c2,
                                        *p1111, *p1121, *p1112, *p1122 );
    ...
    //		Curva* patch12_c4 = new CurvParamBezier ( *p733, *p1131, *p1132, *p1133 );
    ...
    Patch* patch13 = new BezierPatch (	patch13_c1, patch13_c2, patch13_c3, patch13_c4,
                                        *p1311, *p1321, *p1312, *p1322 );
    ...
    //		Curva* patch14_c2 = new CurvParamBezier ( *p1300, *p1301, *p1302, *p1303 );
    Curva* patch14_c3 = new CurvParamBezier ( *p1333, *p1413, *p1423, *p1303 );
    //		Curva* patch14_c4 = new CurvParamBezier ( *p1330, *p1331, *p1332, *p1333 );

    Patch* patch14 = new BezierPatch (	patch14_c1, patch13_c4, patch14_c3, patch13_c2,
                                        *p1411, *p1421, *p1412, *p1422 );
    ...
    //		Curva* patch15_c1 = new CurvParamBezier ( *p1303, *p1313, *p1323, *p1333 );
    ...
    Patch* patch15 = new BezierPatch (	patch13_c3, patch15_c2, patch15_c3, patch15_c4,
                                        *p1511, *p1521, *p1512, *p1522 );
    ...
    //		Curva* patch16_c1 = new CurvParamBezier ( *p1333, *p1413, *p1423, *p1303 );
    //		Curva* patch16_c2 = new CurvParamBezier ( *p1303, *p1501, *p1502, *p633 );
    Curva* patch16_c3 = new CurvParamBezier ( *p1533, *p1613, *p1623, *p633 );
    //		Curva* patch16_c4 = new CurvParamBezier ( *p1333, *p1531, *p1532, *p1533 );

    Patch* patch16 = new BezierPatch (	patch14_c3, patch15_c4, patch16_c3, patch15_c2,
                                        *p1611, *p1621, *p1612, *p1622 );
    ...
    Patch* patch17 = new BezierPatch (	patch17_c1, patch17_c2, patch17_c3, patch17_c4,
                                        *p1711, *p1721, *p1712, *p1722 );
    ...
    //		Curva* patch18_c2 = new CurvParamBezier ( *p1700, *p1701, *p1702, *p1703 );
    Curva* patch18_c3 = new CurvParamBezier ( *p1733, *p1813, *p1823, *p1703 );
    //		Curva* patch18_c4 = new CurvParamBezier ( *p1730, *p1731, *p1732, *p1733 );

    Patch* patch18 = new BezierPatch (	patch18_c1, patch17_c4, patch18_c3, patch17_c2,
                                        *p1811, *p1821, *p1812, *p1822 );
    ...
    //============================== PATCH 19 ==================================
    //		Ponto* p1703 = p1703; //new Vertice ( 2.70000, 0.00000, 2.40000 );
    //		Ponto* p1713 = p1713; //new Vertice ( 2.70000,-0.25000, 2.40000 );3.30000, 0.25000, 2.40000
    //		Ponto* p1723 = p1723; //new Vertice ( 3.30000,-0.25000, 2.40000 );
    //		Ponto* p1733 = p1733; //new Vertice ( 3.30000, 0.00000, 2.40000 );
    ...
    //		Curva* patch19_c1 = new CurvParamBezier ( *p1703, *p1713, *p1723, *p1733 );
    ...
    Patch* patch19 = new BezierPatch (	patch17_c3, patch19_c2, patch19_c3, patch19_c4,
                                        *p1911, *p1921, *p1912, *p1922 );
    ...
    //		Curva* patch20_c2 = new CurvParamBezier ( *p1703, *p1901, *p1902, *p1903 );
    Curva* patch20_c3 = new CurvParamBezier ( *p1933, *p1933, *p2023, *p1903 );
    //		Curva* patch20_c4 = new CurvParamBezier ( *p1733, *p1931, *p1932, *p1933 );

    Patch* patch20 = new BezierPatch (	patch20_c1, patch19_c4, patch20_c3, patch19_c2,
                                        *p2011, *p2021, *p2012, *p2022 );
    ...
    Patch* patch21 = new BezierPatch (	patch21_c1, patch21_c2, patch21_c3, patch21_c4,
                                        *p2111, *p2121, *p2102, *p2102 );
    ...
    //		Curva* patch22_c4 = new CurvParamBezier ( *p2130, *p2131, *p2102, *p2133 );

    Patch* patch22 = new BezierPatch (	patch22_c1, patch22_c2, patch22_c3, patch21_c2,
                                        *p2211, *p2221, *p2102, *p2102 );
    ...
    //		Curva* patch23_c4 = new CurvParamBezier ( *p2230, *p2231, *p2102, *p2233 );

    Patch* patch23 = new BezierPatch (	patch23_c1, patch23_c2, patch23_c3, patch22_c2,
                                        *p2311, *p2321, *p2102, *p2102 );
    ...
    //		Curva* patch24_c4 = new CurvParamBezier ( *p2330, *p2331, *p2102, *p2333 );

    Patch* patch24 = new BezierPatch (	patch24_c1, patch24_c2, patch24_c3, patch23_c2,
                                        *p2411, *p2421, *p2102, *p2102 );
    ...
    //		Curva* patch25_c1 = new CurvParamBezier ( *p2103, *p2113, *p2123, *p2133 );
    ...
    Patch* patch25 = new BezierPatch (	patch21_c3, patch25_c2, patch25_c3, patch25_c4,
                                        *p2511, *p2521, *p2512, *p2522 );
    ...
    //		Curva* patch26_c1 = new CurvParamBezier ( *p2133, *p2213, *p2223, *p2233 );
    Curva* patch26_c2 = new CurvParamBezier ( *p2233, *p2631, *p2632, *p2633 );
    Curva* patch26_c3 = new CurvParamBezier ( *p2533, *p2613, *p2623, *p2633 );
    //		Curva* patch26_c4 = new CurvParamBezier ( *p2133, *p2531, *p2532, *p2533 );

    Patch* patch26 = new BezierPatch (	patch22_c3, patch26_c2, patch26_c3, patch25_c2,
                                        *p2611, *p2621, *p2612, *p2622 );
    ...
    //		Curva* patch27_c1 = new CurvParamBezier ( *p2233, *p2313, *p2323, *p2333 );
    Curva* patch27_c2 = new CurvParamBezier ( *p2333, *p2731, *p2732, *p2733 );
    Curva* patch27_c3 = new CurvParamBezier ( *p2633, *p2713, *p2723, *p2733 );
    //		Curva* patch27_c4 = new CurvParamBezier ( *p2233, *p2631, *p2632, *p2633 );

    Patch* patch27 = new BezierPatch (	patch23_c3, patch27_c2, patch27_c3, patch26_c2,
                                        *p2711, *p2721, *p2712, *p2722 );
    ...
    //		Curva* patch28_c1 = new CurvParamBezier ( *p2333, *p2413, *p2423, *p2103 );
    //		Curva* patch28_c2 = new CurvParamBezier ( *p2103, *p2501, *p2502, *p2503 );
    Curva* patch28_c3 = new CurvParamBezier ( *p2733, *p2813, *p2823, *p2503 );
    //		Curva* patch28_c4 = new CurvParamBezier ( *p2333, *p2731, *p2732, *p2733 );

    Patch* patch28 = new BezierPatch (	patch24_c3, patch25_c4, patch28_c3, patch27_c2,
                                        *p2811, *p2821, *p2812, *p2822 );
    ...
    Patch* patch29 = new BezierPatch (	patch29_c1, patch29_c2, patch29_c3, patch29_c4,
                                        *p2911, *p2921, *p2912, *p2922 );
    ...
    //		Curva* patch30_c4 = new CurvParamBezier ( *p2930, *p2931, *p2932, *p1133 );

    Patch* patch30 = new BezierPatch (	patch30_c1, patch30_c2, patch30_c3, patch29_c2,
                                        *p3011, *p3021, *p3012, *p3022 );
    ...
    //		Curva* patch31_c4 = new CurvParamBezier ( *p3030, *p3031, *p3032, *p1033 );

    Patch* patch31 = new BezierPatch (	patch31_c1, patch31_c2, patch31_c3, patch30_c2,
                                        *p3111, *p3121, *p3112, *p3122 );
    ...
    //		Curva* patch32_c2 = new CurvParamBezier ( *p2900, *p2901, *p2902, *p903 );
    Curva* patch32_c3 = new CurvParamBezier ( *p933, *p923, *p913, *p903 );
    //		Curva* patch32_c4 = new CurvParamBezier ( *p3130, *p3131, *p3132, *p933 );

    Patch* patch32 = new BezierPatch (	patch32_c1, patch29_c4, patch32_c3, patch31_c2,
                                        *p3211, *p3221, *p3212, *p3222 );
