...
void Parallel::Communicator::pack(char val, void *buffer, Int bufferSize, Int &position) const
{
	this->pack(&val, 1, buffer, bufferSize, position, CHAR);
}

void Parallel::Communicator::pack(unsigned char val, void *buffer, Int bufferSize, Int &position) const
{
	this->pack(&val, 1, buffer, bufferSize, position, UCHAR);
}

void Parallel::Communicator::pack(bool val, void *buffer, Int bufferSize, Int &position) const
{
	this->pack(&val, 1, buffer, bufferSize, position, BOOL);
}

void Parallel::Communicator::pack(short val, void *buffer, Int bufferSize, Int &position) const
{
	this->pack(&val, 1, buffer, bufferSize, position, SHORT);
}

void Parallel::Communicator::pack(unsigned short val, void *buffer, Int bufferSize, Int &position) const
{
	this->pack(&val, 1, buffer, bufferSize, position, USHORT);
}

void Parallel::Communicator::pack(Int val, void *buffer, Int bufferSize, Int &position) const
{
	this->pack(&val, 1, buffer, bufferSize, position, INT);
}

void Parallel::Communicator::pack(UInt val, void *buffer, Int bufferSize, Int &position) const
{
	this->pack(&val, 1, buffer, bufferSize, position, UINT);
}

void Parallel::Communicator::pack(LInt val, void *buffer, Int bufferSize, Int &position) const
{
	this->pack(&val, 1, buffer, bufferSize, position, LINT);
}

void Parallel::Communicator::pack(ULInt val, void *buffer, Int bufferSize, Int &position) const
{
	this->pack(&val, 1, buffer, bufferSize, position, ULINT);
}

void Parallel::Communicator::pack(Real val, void *buffer, Int bufferSize, Int &position) const
{
	this->pack(&val, 1, buffer, bufferSize, position, REAL);
}

void Parallel::Communicator::pack(LReal val, void *buffer, Int bufferSize, Int &position) const
{
	this->pack(&val, 1, buffer, bufferSize, position, LREAL);
}

void Parallel::Communicator::pack(const char *val, Int size, void *buffer, Int bufferSize, Int &position) const
{
	this->pack(val, size, buffer, bufferSize, position, CHAR);
}

void Parallel::Communicator::pack(const unsigned char *val, Int size, void *buffer, Int bufferSize, Int &position) const
{
	this->pack(val, size, buffer, bufferSize, position, UCHAR);
}

void Parallel::Communicator::pack(const bool *val, Int size, void *buffer, Int bufferSize, Int &position) const
{
	this->pack(val, size, buffer, bufferSize, position, BOOL);
}

void Parallel::Communicator::pack(const short *val, Int size, void *buffer, Int bufferSize, Int &position) const
{
	this->pack(val, size, buffer, bufferSize, position, SHORT);
}

void Parallel::Communicator::pack(const unsigned short *val, Int size, void *buffer, Int bufferSize, Int &position) const
{
	this->pack(val, size, buffer, bufferSize, position, USHORT);
}

void Parallel::Communicator::pack(const Int *val, Int size, void *buffer, Int bufferSize, Int &position) const
{
	this->pack(val, size, buffer, bufferSize, position, INT);
}

void Parallel::Communicator::pack(const UInt *val, Int size, void *buffer, Int bufferSize, Int &position) const
{
	this->pack(val, size, buffer, bufferSize, position, UINT);
}

void Parallel::Communicator::pack(const LInt *val, Int size, void *buffer, Int bufferSize, Int &position) const
{
	this->pack(val, size, buffer, bufferSize, position, LINT);
}

void Parallel::Communicator::pack(const ULInt *val, Int size, void *buffer, Int bufferSize, Int &position) const
{
	this->pack(val, size, buffer, bufferSize, position, ULINT);
}

void Parallel::Communicator::pack(const Real *val, Int size, void *buffer, Int bufferSize, Int &position) const
{
	this->pack(val, size, buffer, bufferSize, position, REAL);
}

void Parallel::Communicator::pack(const LReal *val, Int size, void *buffer, Int bufferSize, Int &position) const
{
	this->pack(val, size, buffer, bufferSize, position, LREAL);
}

void Parallel::Communicator::unpack(char &val, const void *buffer, Int bufferSize, Int &position) const
{
	this->unpack(&val, 1, buffer, bufferSize, position, CHAR);
}

void Parallel::Communicator::unpack(unsigned char &val, const void *buffer, Int bufferSize, Int &position) const
{
	this->unpack(&val, 1, buffer, bufferSize, position, UCHAR);
}

void Parallel::Communicator::unpack(bool &val, const void *buffer, Int bufferSize, Int &position) const
{
	this->unpack(&val, 1, buffer, bufferSize, position, BOOL);
}

void Parallel::Communicator::unpack(short &val, const void *buffer, Int bufferSize, Int &position) const
{
	this->unpack(&val, 1, buffer, bufferSize, position, SHORT);
}

void Parallel::Communicator::unpack(unsigned short &val, const void *buffer, Int bufferSize, Int &position) const
{
	this->unpack(&val, 1, buffer, bufferSize, position, USHORT);
}

void Parallel::Communicator::unpack(Int &val, const void *buffer, Int bufferSize, Int &position) const
{
	this->unpack(&val, 1, buffer, bufferSize, position, INT);
}

void Parallel::Communicator::unpack(UInt &val, const void *buffer, Int bufferSize, Int &position) const
{
	this->unpack(&val, 1, buffer, bufferSize, position, UINT);
}

void Parallel::Communicator::unpack(LInt &val, const void *buffer, Int bufferSize, Int &position) const
{
	this->unpack(&val, 1, buffer, bufferSize, position, LINT);
}

void Parallel::Communicator::unpack(ULInt &val, const void *buffer, Int bufferSize, Int &position) const
{
	this->unpack(&val, 1, buffer, bufferSize, position, ULINT);
}

void Parallel::Communicator::unpack(Real &val, const void *buffer, Int bufferSize, Int &position) const
{
	this->unpack(&val, 1, buffer, bufferSize, position, REAL);
}

void Parallel::Communicator::unpack(LReal &val, const void *buffer, Int bufferSize, Int &position) const
{
	this->unpack(&val, 1, buffer, bufferSize, position, LREAL);
}

void Parallel::Communicator::unpack(char *val, Int size, const void *buffer, Int bufferSize, Int &position) const
{
	this->unpack(val, size, buffer, bufferSize, position, CHAR);
}

void Parallel::Communicator::unpack(unsigned char *val, Int size, const void *buffer, Int bufferSize, Int &position) const
{
	this->unpack(val, size, buffer, bufferSize, position, UCHAR);
}

void Parallel::Communicator::unpack(bool *val, Int size, const void *buffer, Int bufferSize, Int &position) const
{
	this->unpack(val, size, buffer, bufferSize, position, BOOL);
}

void Parallel::Communicator::unpack(short *val, Int size, const void *buffer, Int bufferSize, Int &position) const
{
	this->unpack(val, size, buffer, bufferSize, position, SHORT);
}

void Parallel::Communicator::unpack(unsigned short *val, Int size, const void *buffer, Int bufferSize, Int &position) const
{
	this->unpack(val, size, buffer, bufferSize, position, USHORT);
}

void Parallel::Communicator::unpack(Int *val, Int size, const void *buffer, Int bufferSize, Int &position) const
{
	this->unpack(val, size, buffer, bufferSize, position, INT);
}

void Parallel::Communicator::unpack(UInt *val, Int size, const void *buffer, Int bufferSize, Int &position) const
{
	this->unpack(val, size, buffer, bufferSize, position, UINT);
}

void Parallel::Communicator::unpack(LInt *val, Int size, const void *buffer, Int bufferSize, Int &position) const
{
	this->unpack(val, size, buffer, bufferSize, position, LINT);
}

void Parallel::Communicator::unpack(ULInt *val, Int size, const void *buffer, Int bufferSize, Int &position) const
{
	this->unpack(val, size, buffer, bufferSize, position, ULINT);
}

void Parallel::Communicator::unpack(Real *val, Int size, const void *buffer, Int bufferSize, Int &position) const
{
	this->unpack(val, size, buffer, bufferSize, position, REAL);
}

void Parallel::Communicator::unpack(LReal *val, Int size, const void *buffer, Int bufferSize, Int &position) const
{
...
void Parallel::Communicator::broadcast(unsigned char *val, Int size, Int root) const
{
...
void Parallel::Communicator::broadcast(unsigned short *val, Int size, Int root) const
{
...
void Parallel::Communicator::broadcastv(Transferable **const t, Int size) const
{
	Package p = std::make_pair(0, static_cast<char *>(NULL));
	Int sizes[size];
...
void Parallel::Communicator::scatter(unsigned char *val, Int size, Int root) const
{
	unsigned char *buf = NULL;
...
void Parallel::Communicator::scatter(const unsigned short *val, Int size) const
{
...
void Parallel::Communicator::scatter(unsigned short *val, Int size, Int root) const
{
	unsigned short *buf = NULL;
...
void Parallel::Communicator::scatter(Transferable **const t) const
{
	...
	this->scatterv(p.second, sizes, displacements, &ignore, sizes[rank], PACKED, rank);
...
void Parallel::Communicator::scatterv(Transferable **const t, Int sizes[]) const
{
	Int numProcesses = this->numProcesses();
	...
	this->scatterv(p.second, tpsizes, displacements, &ignore, tpsizes[rank], PACKED, rank);
...
void Parallel::Communicator::gather(unsigned char val, unsigned char *buffer) const
{
...
void Parallel::Communicator::gather(unsigned short val, unsigned short *buffer) const
{
...
void Parallel::Communicator::gather(const char *val, Int size, char *buffer) const
{
	this->gather(val, size, buffer, size, CHAR, this->rank());
}

void Parallel::Communicator::gather(const unsigned char *val, Int size, Int root) const
{
	unsigned char *buf = NULL;
...
void Parallel::Communicator::gather(const unsigned char *val, Int size, unsigned char *buffer) const
{
...
void Parallel::Communicator::gather(const bool *val, Int size, bool *buffer) const
{
	this->gather(val, size, buffer, size, BOOL, this->rank());
}

void Parallel::Communicator::gather(const short *val, Int size, Int root) const
{
	short *buf = NULL;
...
void Parallel::Communicator::gather(const short *val, Int size, short *buffer) const
{
	this->gather(val, size, buffer, size, SHORT, this->rank());
}

void Parallel::Communicator::gather(const unsigned short *val, Int size, Int root) const
{
	unsigned short *buf = NULL;
...
void Parallel::Communicator::gather(const unsigned short *val, Int size, unsigned short *buffer) const
{
...
void Parallel::Communicator::gather(const Int *val, Int size, Int *buffer) const
{
...
void Parallel::Communicator::gather(const UInt *val, Int size, UInt *buffer) const
{
...
void Parallel::Communicator::gather(const LInt *val, Int size, LInt *buffer) const
{
	this->gather(val, size, buffer, size, LINT, this->rank());
}

void Parallel::Communicator::gather(const ULInt *val, Int size, Int root) const
{
	ULInt *buf = NULL;
...
void Parallel::Communicator::gather(const ULInt *val, Int size, ULInt *buffer) const
{
...
void Parallel::Communicator::gather(const Real *val, Int size, Real *buffer) const
{
	this->gather(val, size, buffer, size, REAL, this->rank());
}

void Parallel::Communicator::gather(const LReal *val, Int size, Int root) const
{
	LReal *buf = NULL;
...
void Parallel::Communicator::gather(const LReal *val, Int size, LReal *buffer) const
{
...
void Parallel::Communicator::gatherv(Transferable **const t, Int size, Int root) const
{
	Package p;
	p.first = 0;
	p.second = NULL;
...
unsigned char *Parallel::Communicator::allGather(const unsigned char *val, Int size) const
{
	Int numProcesses = this->numProcesses();
...
unsigned short *Parallel::Communicator::allGather(const unsigned short *val, Int size) const
{
	Int numProcesses = this->numProcesses();
...
unsigned char *Parallel::Communicator::allToAll(const unsigned char *val, Int size) const
{
	Int numProcesses = this->numProcesses();
...
unsigned short *Parallel::Communicator::allToAll(const unsigned short *val, Int size) const
{
	Int numProcesses = this->numProcesses();
...
Transferable **Parallel::Communicator::allToAll(Transferable **const t) const
{
	...
	this->allToAllv(p.second, sizes, displacements, rp.second, rsizes, rdisplacements, PACKED);
...
void Parallel::Communicator::send(unsigned char val, Int process, Int tag) const
{
...
void Parallel::Communicator::send(unsigned short val, Int process, Int tag) const
{
...
void Parallel::Communicator::send(const char *val, Int size, Int process, Int tag) const
{
	this->send(val, size, CHAR, process, tag);
}

void Parallel::Communicator::send(const unsigned char *val, Int size, Int process, Int tag) const
{
	this->send(val, size, UCHAR, process, tag);
}

void Parallel::Communicator::send(const bool *val, Int size, Int process, Int tag) const
{
	this->send(val, size, BOOL, process, tag);
}

void Parallel::Communicator::send(const short *val, Int size, Int process, Int tag) const
{
	this->send(val, size, SHORT, process, tag);
}

void Parallel::Communicator::send(const unsigned short *val, Int size, Int process, Int tag) const
{
	this->send(val, size, USHORT, process, tag);
}

void Parallel::Communicator::send(const Int *val, Int size, Int process, Int tag) const
{
	this->send(val, size, INT, process, tag);
}

void Parallel::Communicator::send(const UInt *val, Int size, Int process, Int tag) const
{
	this->send(val, size, UINT, process, tag);
}

void Parallel::Communicator::send(const LInt *val, Int size, Int process, Int tag) const
{
	this->send(val, size, LINT, process, tag);
}

void Parallel::Communicator::send(const ULInt *val, Int size, Int process, Int tag) const
{
	this->send(val, size, ULINT, process, tag);
}

void Parallel::Communicator::send(const Real *val, Int size, Int process, Int tag) const
{
	this->send(val, size, REAL, process, tag);
}

void Parallel::Communicator::send(const LReal *val, Int size, Int process, Int tag) const
{
	this->send(val, size, LREAL, process, tag);
}

void Parallel::Communicator::send(const Transferable *t, Int process, Int tag) const
{
	Package p = t->pack(this);
...
void Parallel::Communicator::ssend(unsigned char val, Int process, Int tag) const
{
...
void Parallel::Communicator::ssend(unsigned short val, Int process, Int tag) const
{
...
void Parallel::Communicator::ssend(const char *val, Int size, Int process, Int tag) const
{
	this->ssend(val, size, CHAR, process, tag);
}

void Parallel::Communicator::ssend(const unsigned char *val, Int size, Int process, Int tag) const
{
	this->ssend(val, size, UCHAR, process, tag);
}

void Parallel::Communicator::ssend(const bool *val, Int size, Int process, Int tag) const
{
	this->ssend(val, size, BOOL, process, tag);
}

void Parallel::Communicator::ssend(const short *val, Int size, Int process, Int tag) const
{
	this->ssend(val, size, SHORT, process, tag);
}

void Parallel::Communicator::ssend(const unsigned short *val, Int size, Int process, Int tag) const
{
	this->ssend(val, size, USHORT, process, tag);
}

void Parallel::Communicator::ssend(const Int *val, Int size, Int process, Int tag) const
{
	this->ssend(val, size, INT, process, tag);
}

void Parallel::Communicator::ssend(const UInt *val, Int size, Int process, Int tag) const
{
	this->ssend(val, size, UINT, process, tag);
}

void Parallel::Communicator::ssend(const LInt *val, Int size, Int process, Int tag) const
{
	this->ssend(val, size, LINT, process, tag);
}

void Parallel::Communicator::ssend(const ULInt *val, Int size, Int process, Int tag) const
{
	this->ssend(val, size, ULINT, process, tag);
}

void Parallel::Communicator::ssend(const Real *val, Int size, Int process, Int tag) const
{
	this->ssend(val, size, REAL, process, tag);
}

void Parallel::Communicator::ssend(const LReal *val, Int size, Int process, Int tag) const
{
	this->ssend(val, size, LREAL, process, tag);
}

void Parallel::Communicator::ssend(const Transferable *t, Int process, Int tag) const
{
	Package p = t->pack(this);
...
void Parallel::Communicator::bsend(unsigned char val, Int process, Int tag) const
{
...
void Parallel::Communicator::bsend(unsigned short val, Int process, Int tag) const
{
...
void Parallel::Communicator::bsend(const char *val, Int size, Int process, Int tag) const
{
	this->bsend(val, size, CHAR, process, tag);
}

void Parallel::Communicator::bsend(const unsigned char *val, Int size, Int process, Int tag) const
{
	this->bsend(val, size, UCHAR, process, tag);
}

void Parallel::Communicator::bsend(const bool *val, Int size, Int process, Int tag) const
{
	this->bsend(val, size, BOOL, process, tag);
}

void Parallel::Communicator::bsend(const short *val, Int size, Int process, Int tag) const
{
	this->bsend(val, size, SHORT, process, tag);
}

void Parallel::Communicator::bsend(const unsigned short *val, Int size, Int process, Int tag) const
{
	this->bsend(val, size, USHORT, process, tag);
}

void Parallel::Communicator::bsend(const Int *val, Int size, Int process, Int tag) const
{
	this->bsend(val, size, INT, process, tag);
}

void Parallel::Communicator::bsend(const UInt *val, Int size, Int process, Int tag) const
{
	this->bsend(val, size, UINT, process, tag);
}

void Parallel::Communicator::bsend(const LInt *val, Int size, Int process, Int tag) const
{
	this->bsend(val, size, LINT, process, tag);
}

void Parallel::Communicator::bsend(const ULInt *val, Int size, Int process, Int tag) const
{
	this->bsend(val, size, ULINT, process, tag);
}

void Parallel::Communicator::bsend(const Real *val, Int size, Int process, Int tag) const
{
	this->bsend(val, size, REAL, process, tag);
}

void Parallel::Communicator::bsend(const LReal *val, Int size, Int process, Int tag) const
{
	this->bsend(val, size, LREAL, process, tag);
}

void Parallel::Communicator::bsend(const Transferable *t, Int process, Int tag) const
{
	Package p = t->pack(this);
...
void Parallel::Communicator::rsend(unsigned char val, Int process, Int tag) const
{
...
void Parallel::Communicator::rsend(unsigned short val, Int process, Int tag) const
{
...
void Parallel::Communicator::rsend(const char *val, Int size, Int process, Int tag) const
{
	this->rsend(val, size, CHAR, process, tag);
}

void Parallel::Communicator::rsend(const unsigned char *val, Int size, Int process, Int tag) const
{
	this->rsend(val, size, UCHAR, process, tag);
}

void Parallel::Communicator::rsend(const bool *val, Int size, Int process, Int tag) const
{
	this->rsend(val, size, BOOL, process, tag);
}

void Parallel::Communicator::rsend(const short *val, Int size, Int process, Int tag) const
{
	this->rsend(val, size, SHORT, process, tag);
}

void Parallel::Communicator::rsend(const unsigned short *val, Int size, Int process, Int tag) const
{
	this->rsend(val, size, USHORT, process, tag);
}

void Parallel::Communicator::rsend(const Int *val, Int size, Int process, Int tag) const
{
	this->rsend(val, size, INT, process, tag);
}

void Parallel::Communicator::rsend(const UInt *val, Int size, Int process, Int tag) const
{
	this->rsend(val, size, UINT, process, tag);
}

void Parallel::Communicator::rsend(const LInt *val, Int size, Int process, Int tag) const
{
	this->rsend(val, size, LINT, process, tag);
}

void Parallel::Communicator::rsend(const ULInt *val, Int size, Int process, Int tag) const
{
	this->rsend(val, size, ULINT, process, tag);
}

void Parallel::Communicator::rsend(const Real *val, Int size, Int process, Int tag) const
{
	this->rsend(val, size, REAL, process, tag);
}

void Parallel::Communicator::rsend(const LReal *val, Int size, Int process, Int tag) const
{
	this->rsend(val, size, LREAL, process, tag);
}

void Parallel::Communicator::rsend(const Transferable *t, Int process, Int tag) const
{
	Package p = t->pack(this);
...
UInt Parallel::Communicator::isend(unsigned char val, Int process, Int tag) const
{
...
UInt Parallel::Communicator::isend(unsigned short val, Int process, Int tag) const
{
...
UInt Parallel::Communicator::isend(const char *val, Int size, Int process, Int tag) const
{
	return this->isend(val, size, CHAR, process, tag);
}

UInt Parallel::Communicator::isend(const unsigned char *val, Int size, Int process, Int tag) const
{
	return this->isend(val, size, UCHAR, process, tag);
}

UInt Parallel::Communicator::isend(const bool *val, Int size, Int process, Int tag) const
{
	return this->isend(val, size, BOOL, process, tag);
}

UInt Parallel::Communicator::isend(const short *val, Int size, Int process, Int tag) const
{
	return this->isend(val, size, SHORT, process, tag);
}

UInt Parallel::Communicator::isend(const unsigned short *val, Int size, Int process, Int tag) const
{
	return this->isend(val, size, USHORT, process, tag);
}

UInt Parallel::Communicator::isend(const Int *val, Int size, Int process, Int tag) const
{
	return this->isend(val, size, INT, process, tag);
}

UInt Parallel::Communicator::isend(const UInt *val, Int size, Int process, Int tag) const
{
	return this->isend(val, size, UINT, process, tag);
}

UInt Parallel::Communicator::isend(const LInt *val, Int size, Int process, Int tag) const
{
	return this->isend(val, size, LINT, process, tag);
}

UInt Parallel::Communicator::isend(const ULInt *val, Int size, Int process, Int tag) const
{
	return this->isend(val, size, ULINT, process, tag);
}

UInt Parallel::Communicator::isend(const Real *val, Int size, Int process, Int tag) const
{
	return this->isend(val, size, REAL, process, tag);
}

UInt Parallel::Communicator::isend(const LReal *val, Int size, Int process, Int tag) const
{
	return this->isend(val, size, LREAL, process, tag);
}

UInt Parallel::Communicator::isend(const Transferable *t, Int process, Int tag) const
{
	Package p = t->pack(this);
...
UInt Parallel::Communicator::issend(unsigned char val, Int process, Int tag) const
{
...
UInt Parallel::Communicator::issend(unsigned short val, Int process, Int tag) const
{
...
UInt Parallel::Communicator::issend(const char *val, Int size, Int process, Int tag) const
{
	return this->issend(val, size, CHAR, process, tag);
}

UInt Parallel::Communicator::issend(const unsigned char *val, Int size, Int process, Int tag) const
{
	return this->issend(val, size, UCHAR, process, tag);
}

UInt Parallel::Communicator::issend(const bool *val, Int size, Int process, Int tag) const
{
	return this->issend(val, size, BOOL, process, tag);
}

UInt Parallel::Communicator::issend(const short *val, Int size, Int process, Int tag) const
{
	return this->issend(val, size, SHORT, process, tag);
}

UInt Parallel::Communicator::issend(const unsigned short *val, Int size, Int process, Int tag) const
{
	return this->issend(val, size, USHORT, process, tag);
}

UInt Parallel::Communicator::issend(const Int *val, Int size, Int process, Int tag) const
{
	return this->issend(val, size, INT, process, tag);
}

UInt Parallel::Communicator::issend(const UInt *val, Int size, Int process, Int tag) const
{
	return this->issend(val, size, UINT, process, tag);
}

UInt Parallel::Communicator::issend(const LInt *val, Int size, Int process, Int tag) const
{
	return this->issend(val, size, LINT, process, tag);
}

UInt Parallel::Communicator::issend(const ULInt *val, Int size, Int process, Int tag) const
{
	return this->issend(val, size, ULINT, process, tag);
}

UInt Parallel::Communicator::issend(const Real *val, Int size, Int process, Int tag) const
{
	return this->issend(val, size, REAL, process, tag);
}

UInt Parallel::Communicator::issend(const LReal *val, Int size, Int process, Int tag) const
{
	return this->issend(val, size, LREAL, process, tag);
}

UInt Parallel::Communicator::issend(const Transferable *t, Int process, Int tag) const
{
	Package p = t->pack(this);
...
UInt Parallel::Communicator::ibsend(unsigned char val, Int process, Int tag) const
{
...
UInt Parallel::Communicator::ibsend(unsigned short val, Int process, Int tag) const
{
...
UInt Parallel::Communicator::ibsend(const char *val, Int size, Int process, Int tag) const
{
	return this->ibsend(val, size, CHAR, process, tag);
}

UInt Parallel::Communicator::ibsend(const unsigned char *val, Int size, Int process, Int tag) const
{
	return this->ibsend(val, size, UCHAR, process, tag);
}

UInt Parallel::Communicator::ibsend(const bool *val, Int size, Int process, Int tag) const
{
	return this->ibsend(val, size, BOOL, process, tag);
}

UInt Parallel::Communicator::ibsend(const short *val, Int size, Int process, Int tag) const
{
	return this->ibsend(val, size, SHORT, process, tag);
}

UInt Parallel::Communicator::ibsend(const unsigned short *val, Int size, Int process, Int tag) const
{
	return this->ibsend(val, size, USHORT, process, tag);
}

UInt Parallel::Communicator::ibsend(const Int *val, Int size, Int process, Int tag) const
{
	return this->ibsend(val, size, INT, process, tag);
}

UInt Parallel::Communicator::ibsend(const UInt *val, Int size, Int process, Int tag) const
{
	return this->ibsend(val, size, UINT, process, tag);
}

UInt Parallel::Communicator::ibsend(const LInt *val, Int size, Int process, Int tag) const
{
	return this->ibsend(val, size, LINT, process, tag);
}

UInt Parallel::Communicator::ibsend(const ULInt *val, Int size, Int process, Int tag) const
{
	return this->ibsend(val, size, ULINT, process, tag);
}

UInt Parallel::Communicator::ibsend(const Real *val, Int size, Int process, Int tag) const
{
	return this->ibsend(val, size, REAL, process, tag);
}

UInt Parallel::Communicator::ibsend(const LReal *val, Int size, Int process, Int tag) const
{
	return this->ibsend(val, size, LREAL, process, tag);
}

UInt Parallel::Communicator::ibsend(const Transferable *t, Int process, Int tag) const
{
	Package p = t->pack(this);
...
UInt Parallel::Communicator::irsend(unsigned char val, Int process, Int tag) const
{
...
UInt Parallel::Communicator::irsend(unsigned short val, Int process, Int tag) const
{
...
UInt Parallel::Communicator::irsend(const char *val, Int size, Int process, Int tag) const
{
	return this->irsend(val, size, CHAR, process, tag);
}

UInt Parallel::Communicator::irsend(const unsigned char *val, Int size, Int process, Int tag) const
{
	return this->irsend(val, size, UCHAR, process, tag);
}

UInt Parallel::Communicator::irsend(const bool *val, Int size, Int process, Int tag) const
{
	return this->irsend(val, size, BOOL, process, tag);
}

UInt Parallel::Communicator::irsend(const short *val, Int size, Int process, Int tag) const
{
	return this->irsend(val, size, SHORT, process, tag);
}

UInt Parallel::Communicator::irsend(const unsigned short *val, Int size, Int process, Int tag) const
{
	return this->irsend(val, size, USHORT, process, tag);
}

UInt Parallel::Communicator::irsend(const Int *val, Int size, Int process, Int tag) const
{
	return this->irsend(val, size, INT, process, tag);
}

UInt Parallel::Communicator::irsend(const UInt *val, Int size, Int process, Int tag) const
{
	return this->irsend(val, size, UINT, process, tag);
}

UInt Parallel::Communicator::irsend(const LInt *val, Int size, Int process, Int tag) const
{
	return this->irsend(val, size, LINT, process, tag);
}

UInt Parallel::Communicator::irsend(const ULInt *val, Int size, Int process, Int tag) const
{
	return this->irsend(val, size, ULINT, process, tag);
}

UInt Parallel::Communicator::irsend(const Real *val, Int size, Int process, Int tag) const
{
	return this->irsend(val, size, REAL, process, tag);
}

UInt Parallel::Communicator::irsend(const LReal *val, Int size, Int process, Int tag) const
{
	return this->irsend(val, size, LREAL, process, tag);
}

UInt Parallel::Communicator::irsend(const Transferable *t, Int process, Int tag) const
{
	Package p = t->pack(this);
...
void Parallel::Communicator::receive(unsigned char &val, Int process, Int tag) const
{
...
void Parallel::Communicator::receive(unsigned short &val, Int process, Int tag) const
{
...
void Parallel::Communicator::receive(char *val, Int size, Int process, Int tag) const
{
	this->receive(val, size, CHAR, process, tag);
}

void Parallel::Communicator::receive(unsigned char *val, Int size, Int process, Int tag) const
{
	this->receive(val, size, UCHAR, process, tag);
}

void Parallel::Communicator::receive(bool *val, Int size, Int process, Int tag) const
{
	this->receive(val, size, BOOL, process, tag);
}

void Parallel::Communicator::receive(short *val, Int size, Int process, Int tag) const
{
	this->receive(val, size, SHORT, process, tag);
}

void Parallel::Communicator::receive(unsigned short *val, Int size, Int process, Int tag) const
{
	this->receive(val, size, USHORT, process, tag);
}

void Parallel::Communicator::receive(Int *val, Int size, Int process, Int tag) const
{
	this->receive(val, size, INT, process, tag);
}

void Parallel::Communicator::receive(UInt *val, Int size, Int process, Int tag) const
{
	this->receive(val, size, UINT, process, tag);
}

void Parallel::Communicator::receive(LInt *val, Int size, Int process, Int tag) const
{
	this->receive(val, size, LINT, process, tag);
}

void Parallel::Communicator::receive(ULInt *val, Int size, Int process, Int tag) const
{
	this->receive(val, size, ULINT, process, tag);
}

void Parallel::Communicator::receive(Real *val, Int size, Int process, Int tag) const
{
	this->receive(val, size, REAL, process, tag);
}

void Parallel::Communicator::receive(LReal *val, Int size, Int process, Int tag) const
{
...
UInt Parallel::Communicator::ireceive(unsigned char &val, Int process, Int tag) const
{
...
UInt Parallel::Communicator::ireceive(unsigned short &val, Int process, Int tag) const
{
...
UInt Parallel::Communicator::ireceive(char *val, Int size, Int process, Int tag) const
{
	return this->ireceive(val, size, CHAR, process, tag);
}

UInt Parallel::Communicator::ireceive(unsigned char *val, Int size, Int process, Int tag) const
{
	return this->ireceive(val, size, UCHAR, process, tag);
}

UInt Parallel::Communicator::ireceive(bool *val, Int size, Int process, Int tag) const
{
	return this->ireceive(val, size, BOOL, process, tag);
}

UInt Parallel::Communicator::ireceive(short *val, Int size, Int process, Int tag) const
{
	return this->ireceive(val, size, SHORT, process, tag);
}

UInt Parallel::Communicator::ireceive(unsigned short *val, Int size, Int process, Int tag) const
{
	return this->ireceive(val, size, USHORT, process, tag);
}

UInt Parallel::Communicator::ireceive(Int *val, Int size, Int process, Int tag) const
{
	return this->ireceive(val, size, INT, process, tag);
}

UInt Parallel::Communicator::ireceive(UInt *val, Int size, Int process, Int tag) const
{
	return this->ireceive(val, size, UINT, process, tag);
}

UInt Parallel::Communicator::ireceive(LInt *val, Int size, Int process, Int tag) const
{
	return this->ireceive(val, size, LINT, process, tag);
}

UInt Parallel::Communicator::ireceive(ULInt *val, Int size, Int process, Int tag) const
{
	return this->ireceive(val, size, ULINT, process, tag);
}

UInt Parallel::Communicator::ireceive(Real *val, Int size, Int process, Int tag) const
{
	return this->ireceive(val, size, REAL, process, tag);
}

UInt Parallel::Communicator::ireceive(LReal *val, Int size, Int process, Int tag) const
{
...
char Parallel::Communicator::reduce(char val, enum Operation operation, Int root) const
{
	if (root < 0)
	{
		root = this->rank();
...
unsigned char Parallel::Communicator::reduce(unsigned char val, enum Operation operation, Int root) const
{
	if (root < 0)
	{
		root = this->rank();
...
bool Parallel::Communicator::reduce(bool val, enum Operation operation, Int root) const
{
	if (root < 0)
	{
		root = this->rank();
...
short Parallel::Communicator::reduce(short val, enum Operation operation, Int root) const
{
	if (root < 0)
	{
		root = this->rank();
...
unsigned short Parallel::Communicator::reduce(unsigned short val, enum Operation operation, Int root) const
{
	if (root < 0)
	{
		root = this->rank();
...
Int Parallel::Communicator::reduce(Int val, enum Operation operation, Int root) const
{
	if (root < 0)
	{
		root = this->rank();
...
UInt Parallel::Communicator::reduce(UInt val, enum Operation operation, Int root) const
{
	if (root < 0)
	{
		root = this->rank();
...
LInt Parallel::Communicator::reduce(LInt val, enum Operation operation, Int root) const
{
	if (root < 0)
	{
		root = this->rank();
...
ULInt Parallel::Communicator::reduce(ULInt val, enum Operation operation, Int root) const
{
	if (root < 0)
	{
		root = this->rank();
...
Real Parallel::Communicator::reduce(Real val, enum Operation operation, Int root) const
{
	if (root < 0)
	{
		root = this->rank();
...
LReal Parallel::Communicator::reduce(LReal val, enum Operation operation, Int root) const
{
	if (root < 0)
	{
		root = this->rank();
...
char *Parallel::Communicator::reduce(const char *val, Int size, enum Operation operation, Int root) const
{
	if (root < 0)
	{
		root = this->rank();
...
unsigned char *Parallel::Communicator::reduce(const unsigned char *val, Int size, enum Operation operation, Int root) const
{
	if (root < 0)
	{
		root = this->rank();
...
bool *Parallel::Communicator::reduce(const bool *val, Int size, enum Operation operation, Int root) const
{
	if (root < 0)
	{
		root = this->rank();
...
short *Parallel::Communicator::reduce(const short *val, Int size, enum Operation operation, Int root) const
{
	if (root < 0)
	{
		root = this->rank();
...
unsigned short *Parallel::Communicator::reduce(const unsigned short *val, Int size, enum Operation operation, Int root) const
{
	if (root < 0)
	{
		root = this->rank();
	...
	unsigned short *buf = (root == this->rank()) ? new unsigned short[size] : NULL;
...
Int *Parallel::Communicator::reduce(const Int *val, Int size, enum Operation operation, Int root) const
{
	if (root < 0)
	{
		root = this->rank();
...
UInt *Parallel::Communicator::reduce(const UInt *val, Int size, enum Operation operation, Int root) const
{
	if (root < 0)
	{
		root = this->rank();
...
LInt *Parallel::Communicator::reduce(const LInt *val, Int size, enum Operation operation, Int root) const
{
	if (root < 0)
	{
		root = this->rank();
...
ULInt *Parallel::Communicator::reduce(const ULInt *val, Int size, enum Operation operation, Int root) const
{
	if (root < 0)
	{
		root = this->rank();
...
Real *Parallel::Communicator::reduce(const Real *val, Int size, enum Operation operation, Int root) const
{
	if (root < 0)
	{
		root = this->rank();
...
LReal *Parallel::Communicator::reduce(const LReal *val, Int size, enum Operation operation, Int root) const
{
	if (root < 0)
	{
		root = this->rank();
...
char Parallel::Communicator::allReduce(char val, enum Operation operation) const
{
	char buf = ' ';
...
unsigned char Parallel::Communicator::allReduce(unsigned char val, enum Operation operation) const
{
	unsigned char buf = ' ';
...
bool Parallel::Communicator::allReduce(bool val, enum Operation operation) const
{
	bool buf = false;
...
short Parallel::Communicator::allReduce(short val, enum Operation operation) const
{
	short buf = 0;
...
unsigned short Parallel::Communicator::allReduce(unsigned short val, enum Operation operation) const
{
	unsigned short buf = 0;
...
UInt Parallel::Communicator::allReduce(UInt val, enum Operation operation) const
{
	UInt buf = 0;
...
LInt Parallel::Communicator::allReduce(LInt val, enum Operation operation) const
{
	LInt buf = 0;
...
ULInt Parallel::Communicator::allReduce(ULInt val, enum Operation operation) const
{
	ULInt buf = 0;
...
Real Parallel::Communicator::allReduce(Real val, enum Operation operation) const
{
	Real buf = 0.0;
...
LReal Parallel::Communicator::allReduce(LReal val, enum Operation operation) const
{
	LReal buf = 0.0;
...
char *Parallel::Communicator::allReduce(const char *val, Int size, enum Operation operation) const
{
	char *buf = new char[size];
...
unsigned char *Parallel::Communicator::allReduce(const unsigned char *val, Int size, enum Operation operation) const
{
	unsigned char *buf = new unsigned char[size];
...
bool *Parallel::Communicator::allReduce(const bool *val, Int size, enum Operation operation) const
{
	bool *buf = new bool[size];
...
short *Parallel::Communicator::allReduce(const short *val, Int size, enum Operation operation) const
{
	short *buf = new short[size];
...
unsigned short *Parallel::Communicator::allReduce(const unsigned short *val, Int size, enum Operation operation) const
{
	unsigned short *buf = new unsigned short[size];
...
Int *Parallel::Communicator::allReduce(const Int *val, Int size, enum Operation operation) const
{
	Int *buf = new Int[size];
...
UInt *Parallel::Communicator::allReduce(const UInt *val, Int size, enum Operation operation) const
{
	UInt *buf = new UInt[size];
...
LInt *Parallel::Communicator::allReduce(const LInt *val, Int size, enum Operation operation) const
{
	LInt *buf = new LInt[size];
...
ULInt *Parallel::Communicator::allReduce(const ULInt *val, Int size, enum Operation operation) const
{
	ULInt *buf = new ULInt[size];
...
Real *Parallel::Communicator::allReduce(const Real *val, Int size, enum Operation operation) const
{
	Real *buf = new Real[size];
...
LReal *Parallel::Communicator::allReduce(const LReal *val, Int size, enum Operation operation) const
{
	LReal *buf = new LReal[size];
...
char *Parallel::Communicator::reduceScatter(const char *val, enum Operation operation) const
{
...
unsigned char *Parallel::Communicator::reduceScatter(const unsigned char *val, enum Operation operation) const
{
	Int count = this->numProcesses();
...
bool *Parallel::Communicator::reduceScatter(const bool *val, enum Operation operation) const
{
	Int count = this->numProcesses();
...
short *Parallel::Communicator::reduceScatter(const short *val, enum Operation operation) const
{
	Int count = this->numProcesses();
...
unsigned short *Parallel::Communicator::reduceScatter(const unsigned short *val, enum Operation operation) const
{
	Int count = this->numProcesses();
...
Int *Parallel::Communicator::reduceScatter(const Int *val, enum Operation operation) const
{
	Int count = this->numProcesses();
...
UInt *Parallel::Communicator::reduceScatter(const UInt *val, enum Operation operation) const
{
	Int count = this->numProcesses();
...
LInt *Parallel::Communicator::reduceScatter(const LInt *val, enum Operation operation) const
{
	Int count = this->numProcesses();
...
ULInt *Parallel::Communicator::reduceScatter(const ULInt *val, enum Operation operation) const
{
	Int count = this->numProcesses();
...
Real *Parallel::Communicator::reduceScatter(const Real *val, enum Operation operation) const
{
	Int count = this->numProcesses();
...
LReal *Parallel::Communicator::reduceScatter(const LReal *val, enum Operation operation) const
{
	Int count = this->numProcesses();
...
char *Parallel::Communicator::reduceScatter(const char *val, Int size, enum Operation operation) const
{
	Int count = this->numProcesses();
...
unsigned char *Parallel::Communicator::reduceScatter(const unsigned char *val, Int size, enum Operation operation) const
{
	Int count = this->numProcesses();
...
bool *Parallel::Communicator::reduceScatter(const bool *val, Int size, enum Operation operation) const
{
	Int count = this->numProcesses();
...
short *Parallel::Communicator::reduceScatter(const short *val, Int size, enum Operation operation) const
{
	Int count = this->numProcesses();
...
unsigned short *Parallel::Communicator::reduceScatter(const unsigned short *val, Int size, enum Operation operation) const
{
	Int count = this->numProcesses();
...
Int *Parallel::Communicator::reduceScatter(const Int *val, Int size, enum Operation operation) const
{
	Int count = this->numProcesses();
...
UInt *Parallel::Communicator::reduceScatter(const UInt *val, Int size, enum Operation operation) const
{
	Int count = this->numProcesses();
...
LInt *Parallel::Communicator::reduceScatter(const LInt *val, Int size, enum Operation operation) const
{
	Int count = this->numProcesses();
...
ULInt *Parallel::Communicator::reduceScatter(const ULInt *val, Int size, enum Operation operation) const
{
	Int count = this->numProcesses();
...
Real *Parallel::Communicator::reduceScatter(const Real *val, Int size, enum Operation operation) const
{
	Int count = this->numProcesses();
...
LReal *Parallel::Communicator::reduceScatter(const LReal *val, Int size, enum Operation operation) const
{
	Int count = this->numProcesses();
...
Transferable *Parallel::Communicator::unpack(Package &p, bool freeUponSuccess) const
{
