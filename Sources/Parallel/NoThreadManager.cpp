...
Int Parallel::NoThreadManager::getMaxThreads() const
{
	return 1;
}

bool Parallel::NoThreadManager::isInParallel() const
{
	return false;
}

Int Parallel::NoThreadManager::numThreads() const
{
	return 1;
}

Int Parallel::NoThreadManager::threadId() const
{
	return 0;
}
